...
FVector UMyBlueprintFunctionLibraryTest::GetInitialeVelocite(const TArray<int32>& Time, const FString& NomPlanete)
{
...
TArray<float> UMyBlueprintFunctionLibraryTest::ComputePlanetePosition(double jd, TArray<float>& elements, TArray<float>& rates, TArray<float>& extraTerms)
{
